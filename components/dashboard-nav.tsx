...
import { LayoutDashboard, Building2, Receipt, CreditCard, FileText, Users, Wallet, Settings, Calendar } from "lucide-react"
        ...
        <div className="border-b border-border/50 p-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-muted-foreground font-medium">Financiero</span>
            </div>
          </div>
        </div>
